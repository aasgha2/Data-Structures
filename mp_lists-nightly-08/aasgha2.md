...
```
==12869== Memcheck, a memory error detector
==12869== Copyright (C) 2002-2015, and GNU GPL'd, by Julian Seward et al.
==12869== Using Valgrind-3.11.0 and LibVEX; rerun with -h for copyright info
==12869== Command: ./test -r xml "List::insertFront\ size"
==12869== 
==12869== Conditional jump or move depends on uninitialised value(s)
==12869==    at 0x435DDC: List<int>::insertFront(int const&) (List.hpp:55)
==12869==    by 0x430257: ____C_A_T_C_H____T_E_S_T____0() (tests_part1.cpp:23)
==12869==    by 0x472832: Catch::TestInvokerAsFunction::invoke() const (catch.hpp:10892)
==12869==    by 0x462F86: Catch::TestCase::invoke() const (catch.hpp:10793)
==12869==    by 0x462EBC: Catch::RunContext::invokeActiveTestCase() (catch.hpp:9658)
==12869==    by 0x45F416: Catch::RunContext::runCurrentTest(std::__1::basic_string<char, std::__1::char_traits<char>, std::__1::allocator<char> >&, std::__1::basic_string<char, std::__1::char_traits<char>, std::__1::allocator<char> >&) (catch.hpp:9622)
==12869==    by 0x45D9EE: Catch::RunContext::runTest(Catch::TestCase const&) (catch.hpp:9408)
==12869==    by 0x466D86: Catch::(anonymous namespace)::runTests(std::__1::shared_ptr<Catch::Config> const&) (catch.hpp:9948)
==12869==    by 0x465A22: Catch::Session::runInternal() (catch.hpp:10149)
==12869==    by 0x4656EA: Catch::Session::run() (catch.hpp:10106)
==12869==    by 0x465669: Catch::Session::run(int, char**) (catch.hpp:10074)
==12869==    by 0x4926E1: main (catch.hpp:13613)
==12869== 
==12869== Conditional jump or move depends on uninitialised value(s)
==12869==    at 0x435E16: List<int>::insertFront(int const&) (List.hpp:58)
==12869==    by 0x430257: ____C_A_T_C_H____T_E_S_T____0() (tests_part1.cpp:23)
==12869==    by 0x472832: Catch::TestInvokerAsFunction::invoke() const (catch.hpp:10892)
==12869==    by 0x462F86: Catch::TestCase::invoke() const (catch.hpp:10793)
==12869==    by 0x462EBC: Catch::RunContext::invokeActiveTestCase() (catch.hpp:9658)
...
==12869== 
==12869== Conditional jump or move depends on uninitialised value(s)
==12869==    at 0x463030: Catch::RunContext::handleExpr(Catch::AssertionInfo const&, Catch::ITransientExpression const&, Catch::AssertionReaction&) (catch.hpp:9683)
==12869==    by 0x440F0B: Catch::AssertionHandler::handleExpr(Catch::ITransientExpression const&) (catch.hpp:5467)
==12869==    by 0x4303B4: ____C_A_T_C_H____T_E_S_T____0() (tests_part1.cpp:25)
==12869==    by 0x472832: Catch::TestInvokerAsFunction::invoke() const (catch.hpp:10892)
==12869==    by 0x462F86: Catch::TestCase::invoke() const (catch.hpp:10793)
==12869==    by 0x462EBC: Catch::RunContext::invokeActiveTestCase() (catch.hpp:9658)
==12869==    by 0x45F416: Catch::RunContext::runCurrentTest(std::__1::basic_string<char, std::__1::char_traits<char>, std::__1::allocator<char> >&, std::__1::basic_string<char, std::__1::char_traits<char>, std::__1::allocator<char> >&) (catch.hpp:9622)
...
==12869== 
==12869== HEAP SUMMARY:
==12869==     in use at exit: 240 bytes in 10 blocks
==12869==   total heap usage: 2,328 allocs, 2,318 frees, 267,368 bytes allocated
==12869== 
==12869== 240 bytes in 10 blocks are definitely lost in loss record 1 of 1
==12869==    at 0x4C29BE3: malloc (vg_replace_malloc.c:299)
==12869==    by 0x4E5A9C4: operator new(unsigned long) (in /clang+llvm-6.0.1-x86_64-linux-sles11.3/lib/libc++abi.so.1.0)
==12869==    by 0x435D93: List<int>::insertFront(int const&) (List.hpp:51)
==12869==    by 0x430257: ____C_A_T_C_H____T_E_S_T____0() (tests_part1.cpp:23)
==12869==    by 0x472832: Catch::TestInvokerAsFunction::invoke() const (catch.hpp:10892)
==12869==    by 0x462F86: Catch::TestCase::invoke() const (catch.hpp:10793)
==12869==    by 0x462EBC: Catch::RunContext::invokeActiveTestCase() (catch.hpp:9658)
...
==12869== 
==12869== LEAK SUMMARY:
==12869==    definitely lost: 240 bytes in 10 blocks
...
==12869== 
==12869== For counts of detected and suppressed errors, rerun with: -v
==12869== Use --track-origins=yes to see where uninitialised values come from
==12869== ERROR SUMMARY: 13 errors from 4 contexts (suppressed: 0 from 0)
...
==12885== Using Valgrind-3.11.0 and LibVEX; rerun with -h for copyright info
==12885== Command: ./test -r xml "List::_destroy\ empty\ list"
==12885== 
==12885== 
==12885== HEAP SUMMARY:
==12885==     in use at exit: 0 bytes in 0 blocks
==12885==   total heap usage: 2,336 allocs, 2,336 frees, 268,200 bytes allocated
==12885== 
...
This report was generated for **aasgha2** using **a5d19d439d7536b81820d107638c5b2aedd5eb58** (from **October 7th 2019, 12:15:00 am**)
