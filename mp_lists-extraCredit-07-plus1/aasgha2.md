...
==30150== Copyright (C) 2002-2015, and GNU GPL'd, by Julian Seward et al.
==30150== Using Valgrind-3.11.0 and LibVEX; rerun with -h for copyright info
==30150== Command: ./test -r xml "List::insertFront\ size"
==30150== 
==30150== Conditional jump or move depends on uninitialised value(s)
==30150==    at 0x427C1C: List<int>::insertFront(int const&) (List.hpp:55)
==30150==    by 0x421F97: ____C_A_T_C_H____T_E_S_T____0() (tests_part1.cpp:23)
==30150==    by 0x462902: Catch::TestInvokerAsFunction::invoke() const (catch.hpp:10892)
==30150==    by 0x453056: Catch::TestCase::invoke() const (catch.hpp:10793)
==30150==    by 0x452F8C: Catch::RunContext::invokeActiveTestCase() (catch.hpp:9658)
==30150==    by 0x44F4E6: Catch::RunContext::runCurrentTest(std::__1::basic_string<char, std::__1::char_traits<char>, std::__1::allocator<char> >&, std::__1::basic_string<char, std::__1::char_traits<char>, std::__1::allocator<char> >&) (catch.hpp:9622)
==30150==    by 0x44DABE: Catch::RunContext::runTest(Catch::TestCase const&) (catch.hpp:9408)
==30150==    by 0x456E56: Catch::(anonymous namespace)::runTests(std::__1::shared_ptr<Catch::Config> const&) (catch.hpp:9948)
==30150==    by 0x455AF2: Catch::Session::runInternal() (catch.hpp:10149)
==30150==    by 0x4557BA: Catch::Session::run() (catch.hpp:10106)
==30150==    by 0x455739: Catch::Session::run(int, char**) (catch.hpp:10074)
==30150==    by 0x4827B1: main (catch.hpp:13613)
==30150== 
==30150== Conditional jump or move depends on uninitialised value(s)
==30150==    at 0x427C56: List<int>::insertFront(int const&) (List.hpp:58)
==30150==    by 0x421F97: ____C_A_T_C_H____T_E_S_T____0() (tests_part1.cpp:23)
==30150==    by 0x462902: Catch::TestInvokerAsFunction::invoke() const (catch.hpp:10892)
==30150==    by 0x453056: Catch::TestCase::invoke() const (catch.hpp:10793)
==30150==    by 0x452F8C: Catch::RunContext::invokeActiveTestCase() (catch.hpp:9658)
...
==30150== 
==30150== Conditional jump or move depends on uninitialised value(s)
==30150==    at 0x453100: Catch::RunContext::handleExpr(Catch::AssertionInfo const&, Catch::ITransientExpression const&, Catch::AssertionReaction&) (catch.hpp:9683)
==30150==    by 0x430FDB: Catch::AssertionHandler::handleExpr(Catch::ITransientExpression const&) (catch.hpp:5467)
==30150==    by 0x4220F4: ____C_A_T_C_H____T_E_S_T____0() (tests_part1.cpp:25)
==30150==    by 0x462902: Catch::TestInvokerAsFunction::invoke() const (catch.hpp:10892)
==30150==    by 0x453056: Catch::TestCase::invoke() const (catch.hpp:10793)
==30150==    by 0x452F8C: Catch::RunContext::invokeActiveTestCase() (catch.hpp:9658)
==30150==    by 0x44F4E6: Catch::RunContext::runCurrentTest(std::__1::basic_string<char, std::__1::char_traits<char>, std::__1::allocator<char> >&, std::__1::basic_string<char, std::__1::char_traits<char>, std::__1::allocator<char> >&) (catch.hpp:9622)
...
==30150== 
==30150== HEAP SUMMARY:
==30150==     in use at exit: 240 bytes in 10 blocks
==30150==   total heap usage: 2,113 allocs, 2,103 frees, 251,496 bytes allocated
==30150== 
==30150== 240 bytes in 10 blocks are definitely lost in loss record 1 of 1
==30150==    at 0x4C29BE3: malloc (vg_replace_malloc.c:299)
==30150==    by 0x4E5A9C4: operator new(unsigned long) (in /clang+llvm-6.0.1-x86_64-linux-sles11.3/lib/libc++abi.so.1.0)
==30150==    by 0x427BD3: List<int>::insertFront(int const&) (List.hpp:51)
==30150==    by 0x421F97: ____C_A_T_C_H____T_E_S_T____0() (tests_part1.cpp:23)
==30150==    by 0x462902: Catch::TestInvokerAsFunction::invoke() const (catch.hpp:10892)
==30150==    by 0x453056: Catch::TestCase::invoke() const (catch.hpp:10793)
==30150==    by 0x452F8C: Catch::RunContext::invokeActiveTestCase() (catch.hpp:9658)
...
==30150== 
==30150== LEAK SUMMARY:
==30150==    definitely lost: 240 bytes in 10 blocks
==30150==    indirectly lost: 0 bytes in 0 blocks
==30150==      possibly lost: 0 bytes in 0 blocks
==30150==    still reachable: 0 bytes in 0 blocks
==30150==         suppressed: 0 bytes in 0 blocks
==30150== 
==30150== For counts of detected and suppressed errors, rerun with: -v
==30150== Use --track-origins=yes to see where uninitialised values come from
==30150== ERROR SUMMARY: 13 errors from 4 contexts (suppressed: 0 from 0)
...
==30165== Command: ./test -r xml "List::_destroy\ empty\ list"
==30165== 
==30165== 
==30165== HEAP SUMMARY:
==30165==     in use at exit: 0 bytes in 0 blocks
==30165==   total heap usage: 2,121 allocs, 2,121 frees, 252,328 bytes allocated
==30165== 
