...
==28439== Copyright (C) 2002-2015, and GNU GPL'd, by Julian Seward et al.
==28439== Using Valgrind-3.11.0 and LibVEX; rerun with -h for copyright info
==28439== Command: ./test -r xml "List::insertFront\ size"
==28439== 
==28439== Conditional jump or move depends on uninitialised value(s)
==28439==    at 0x435DDC: List<int>::insertFront(int const&) (List.hpp:75)
==28439==    by 0x430257: ____C_A_T_C_H____T_E_S_T____0() (tests_part1.cpp:23)
==28439==    by 0x472832: Catch::TestInvokerAsFunction::invoke() const (catch.hpp:10892)
==28439==    by 0x462F86: Catch::TestCase::invoke() const (catch.hpp:10793)
==28439==    by 0x462EBC: Catch::RunContext::invokeActiveTestCase() (catch.hpp:9658)
==28439==    by 0x45F416: Catch::RunContext::runCurrentTest(std::__1::basic_string<char, std::__1::char_traits<char>, std::__1::allocator<char> >&, std::__1::basic_string<char, std::__1::char_traits<char>, std::__1::allocator<char> >&) (catch.hpp:9622)
==28439==    by 0x45D9EE: Catch::RunContext::runTest(Catch::TestCase const&) (catch.hpp:9408)
==28439==    by 0x466D86: Catch::(anonymous namespace)::runTests(std::__1::shared_ptr<Catch::Config> const&) (catch.hpp:9948)
==28439==    by 0x465A22: Catch::Session::runInternal() (catch.hpp:10149)
==28439==    by 0x4656EA: Catch::Session::run() (catch.hpp:10106)
==28439==    by 0x465669: Catch::Session::run(int, char**) (catch.hpp:10074)
==28439==    by 0x4926E1: main (catch.hpp:13613)
==28439== 
==28439== Conditional jump or move depends on uninitialised value(s)
==28439==    at 0x435E16: List<int>::insertFront(int const&) (List.hpp:78)
==28439==    by 0x430257: ____C_A_T_C_H____T_E_S_T____0() (tests_part1.cpp:23)
==28439==    by 0x472832: Catch::TestInvokerAsFunction::invoke() const (catch.hpp:10892)
==28439==    by 0x462F86: Catch::TestCase::invoke() const (catch.hpp:10793)
==28439==    by 0x462EBC: Catch::RunContext::invokeActiveTestCase() (catch.hpp:9658)
...
==28439== 
==28439== Conditional jump or move depends on uninitialised value(s)
==28439==    at 0x463030: Catch::RunContext::handleExpr(Catch::AssertionInfo const&, Catch::ITransientExpression const&, Catch::AssertionReaction&) (catch.hpp:9683)
==28439==    by 0x440F0B: Catch::AssertionHandler::handleExpr(Catch::ITransientExpression const&) (catch.hpp:5467)
==28439==    by 0x4303B4: ____C_A_T_C_H____T_E_S_T____0() (tests_part1.cpp:25)
==28439==    by 0x472832: Catch::TestInvokerAsFunction::invoke() const (catch.hpp:10892)
==28439==    by 0x462F86: Catch::TestCase::invoke() const (catch.hpp:10793)
==28439==    by 0x462EBC: Catch::RunContext::invokeActiveTestCase() (catch.hpp:9658)
==28439==    by 0x45F416: Catch::RunContext::runCurrentTest(std::__1::basic_string<char, std::__1::char_traits<char>, std::__1::allocator<char> >&, std::__1::basic_string<char, std::__1::char_traits<char>, std::__1::allocator<char> >&) (catch.hpp:9622)
...
==28439== 
==28439== HEAP SUMMARY:
==28439==     in use at exit: 240 bytes in 10 blocks
==28439==   total heap usage: 2,328 allocs, 2,318 frees, 267,368 bytes allocated
==28439== 
==28439== 240 bytes in 10 blocks are definitely lost in loss record 1 of 1
==28439==    at 0x4C29BE3: malloc (vg_replace_malloc.c:299)
==28439==    by 0x4E5A9C4: operator new(unsigned long) (in /clang+llvm-6.0.1-x86_64-linux-sles11.3/lib/libc++abi.so.1.0)
==28439==    by 0x435D93: List<int>::insertFront(int const&) (List.hpp:71)
==28439==    by 0x430257: ____C_A_T_C_H____T_E_S_T____0() (tests_part1.cpp:23)
==28439==    by 0x472832: Catch::TestInvokerAsFunction::invoke() const (catch.hpp:10892)
==28439==    by 0x462F86: Catch::TestCase::invoke() const (catch.hpp:10793)
==28439==    by 0x462EBC: Catch::RunContext::invokeActiveTestCase() (catch.hpp:9658)
...
==28439== 
==28439== LEAK SUMMARY:
==28439==    definitely lost: 240 bytes in 10 blocks
==28439==    indirectly lost: 0 bytes in 0 blocks
==28439==      possibly lost: 0 bytes in 0 blocks
==28439==    still reachable: 0 bytes in 0 blocks
==28439==         suppressed: 0 bytes in 0 blocks
==28439== 
==28439== For counts of detected and suppressed errors, rerun with: -v
==28439== Use --track-origins=yes to see where uninitialised values come from
==28439== ERROR SUMMARY: 13 errors from 4 contexts (suppressed: 0 from 0)
...
==28450== Command: ./test -r xml "List::_destroy\ empty\ list"
==28450== 
==28450== 
==28450== HEAP SUMMARY:
==28450==     in use at exit: 0 bytes in 0 blocks
==28450==   total heap usage: 2,336 allocs, 2,336 frees, 268,200 bytes allocated
==28450== 
